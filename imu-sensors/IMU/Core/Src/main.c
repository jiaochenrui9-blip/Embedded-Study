...
int main(void)
{
  ...
  MX_TIM8_Init();
  /* USER CODE BEGIN 2 */
  BMI088_STATUS = BMI088_Init(&hspi1);
  if (BMI088_STATUS != BMI088_OK)
  {
    Error_Handler();
  }

  HAL_Delay(500u);
  BMI088_STATUS = BMI088_CalibrateGyro(2000u);
  if (BMI088_STATUS != BMI088_OK)
  {
    Error_Handler();
  }

  IST8310_STATUS = IST8310_Init(&hi2c3);
  if (IST8310_STATUS != IST8310_OK)
  {
    Error_Handler();
  }
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, Red_OLED_Pin|Green_OLED_Pin|Blue_OLED_Pin, GPIO_PIN_RESET);
...
{
  IST8310_I2C_MemRxCpltCallback(hi2c);
}

void HAL_I2C_MemTxCpltCallback(I2C_HandleTypeDef *hi2c)
{
  IST8310_I2C_MemTxCpltCallback(hi2c);
}
