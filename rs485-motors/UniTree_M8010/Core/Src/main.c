...
/* USER CODE BEGIN PV */
static M8010_MotorManager_t m8010_manager;
static M8010_Motor_t m8010_motor;
/* USER CODE END PV */
...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
  if ((M8010_MotorManager_Init(&m8010_manager,
                                &huart1,
                                RS485_DIR_GPIO_Port,
                                RS485_DIR_Pin) != HAL_OK) ||
      (M8010_MotorManager_Register(&m8010_manager,
                                    &m8010_motor,
                                    M8010_MOTOR_ID) != HAL_OK))
  {
    Error_Handler();
  }
...
void HAL_UART_TxCpltCallback(UART_HandleTypeDef *huart)
{
  ...
  {
    M8010_MotorManager_TxCallBack(&m8010_manager);
  }
}
